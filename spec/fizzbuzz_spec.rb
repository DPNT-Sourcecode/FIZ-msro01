...
describe FizzBuzz do
    ...
    it 'returns "fizz fake deluxe" if number is odd, divisible by 3 and contains a 3 but is not divisible by 5 and does not contain a 5' do
        f = FizzBuzz.new
        expect(f.fizz_buzz(33)).to eq("fizz fake deluxe")
        expect(f.fizz_buzz(303)).to eq("fizz fake deluxe")
    end

    it 'returns "buzz fake deluxe" if number is odd, divisible by 5 and contains a 5 but is not divisible by 3 and does not contain a 3' do
        f = FizzBuzz.new
